...
class PageTest(FlaskTest):
    ...
    def test_page(self):
        ...
        page1 = self.mixer.blend('base.pages.models.Page', content=self.mixer.random)
        ...
        page2 = self.mixer.blend('base.pages.models.Page', content=self.mixer.random, parent=page1)
        with self.assertNumQueries(2):
            self.assertEqual(page2.uri, '/p/{slug1}/{slug2}/'.format(slug1=page1.slug, slug2=page2.slug))
        ...
        page3 = self.mixer.blend('base.pages.models.Page', link='http://google.com', parent=page1)
